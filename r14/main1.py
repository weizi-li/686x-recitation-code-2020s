...
class QAgent:
    def __init__(self, env):
        ...
        self.observation_bounds = list(zip(env.observation_space.low, env.observation_space.high))
...
def train_DQNAgent(env):
    ...
    for e in range(max_episodes):
        ...
        for t in range(max_time_steps):
            ...
            if done:
                print("Episode {} finished after {} time steps".format(e, t))
        ...
        print('Number of consecutive successful episodes: %d\n' % num_success_episodes_so_far)
